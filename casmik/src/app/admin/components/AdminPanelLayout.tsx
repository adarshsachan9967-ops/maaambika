  ...
  const SidebarContent = () => (
    <>
      <div className={`flex items-center h-16 border-b border-white/10 flex-shrink-0 ${collapsed ? 'justify-center px-0' : 'px-4 gap-3'}`}>
        ...
        {!collapsed && (
          <div>
            <p className="font-black text-white text-sm leading-none">Maa Ambika</p>
            <p className="text-[10px] text-amber-400 font-semibold leading-none mt-1">Mobile Shop Admin</p>
          </div>
        )}
      </div>
